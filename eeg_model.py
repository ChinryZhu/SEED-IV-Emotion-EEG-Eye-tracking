...
Modifications made by Chinry Zhu on 09/08/2025
 - Fixed incorrect variable reference names in RegionRNN module
 - Corrected naming inconsistencies between variable declarations and calls
...
class RegionRNN(nn.Module):
    ...
    def forward(self, x):
        ...
        x_pl, _ = self.RNN_pL(p_l, h0)
        x_pr, _ = self.RNN_pR(p_r, h0)
